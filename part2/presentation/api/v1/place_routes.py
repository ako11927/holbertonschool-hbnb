...
place_with_relationships_model = api.model('PlaceWithRelationships', {
    'id': fields.String(description='Place ID'),
    'name': fields.String(description='Place name'),
    'description': fields.String(description='Description'),
    'owner': fields.Nested(api.models['User'], description='Owner details'),
    'amenities': fields.List(fields.Nested(api.models['Amenity']), description='Amenities'),
    'number_rooms': fields.Integer(description='Number of rooms'),
    'number_bathrooms': fields.Integer(description='Number of bathrooms'),
    'max_guest': fields.Integer(description='Maximum guests'),
    'price_by_night': fields.String(description='Price per night'),
...
class PlaceResource(Resource):
    @api.doc('get_place')
    @api.marshal_with(place_with_relationships_model)
    def get(self, place_id):
        """
        Retrieve a place by ID with relationships.
        
        Args:
            place_id: Place identifier
            
        Returns:
            Place data with owner and amenities
        """
        ...
        response['owner'] = owner.to_dict() if owner else None
